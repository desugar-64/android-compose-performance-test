...
--- | ---: | ---: | ---: | ---: | ---:
addItemsToColumn | `7.2` / `14.4` | `9.0` / `13.9` | `9.8` / `13.9` | `9.5` / `15.0` | `9.5` / `14.9`
itemRecomposition | `5.3` / `15.4` | `5.8` / `16.4` | `6.3` / `16.0` | `9.6` / `16.6` | `6.1` / `16.2`
lazyListFling | `3.8` / `5.3` | `4.2` / `6.3` | `4.5` / `6.2` | `4.6` / `7.3` | `4.9` / `6.5`
lazyListScroll | `5.1` / `6.4` | `6.1` / `10.2` | `9.6` / `12.3` | `7.8` / `15.1` | `9.5` / `11.9`
navigateToScreen | `5.2` / `9.8` | `6.8` / `11.4` | `9.6` / `14.1` | `7.1` / `13.6` | `7.2` / `12.2`
particlesCanvas | `5.6` / `7.2` | `7.1` / `16.1` | `6.8` / `8.5` | `6.8` / `8.4` | `6.2` / `8.2`
particlesCustomLayout | `7.1` / `10.1` | `8.3` / `11.6` | `10.0` / `12.6` | `9.2` / `11.9` | `9.7` / `12.4`
particlesLayoutLayer | `9.2` / `10.5` | `10.1` / `11.9` | `11.0` / `13.3` | `11.0` / `12.7` | `11.0` / `13.3`
particlesLayoutOffset | `9.6` / `10.9` | `10.0` / `14.5` | `12.0` / `13.8` | `11.8` / `13.8` | `11.6` / `13.8`
transitionAnimation | `10.1` / `11.4` | `10.8` / `16.3` | `14.3` / `16.6` | `11.0` / `13.6` | `10.5` / `12.3`
<br/>
